...
export default async function ComparePage({
  ...
  return (
    <div className="w-full min-w-0 max-w-full px-4 py-6 lg:max-w-7xl lg:px-6 lg:py-8 lg:mx-auto">
      <BreadcrumbNav
        items={[{ label: "خانه", href: "/" }, { label: "مقایسه خودروها" }]}
        className="mb-4"
      />
      ...
      {cars.length === 0 ? (
        <div className="text-center py-16 text-muted-foreground">
          <p className="text-lg mb-2">
            هنوز خودرویی برای مقایسه انتخاب نشده است.
          </p>
          <p className="text-sm">
            از صفحه جستجو یا صفحه هر خودرو، دکمه «مقایسه» را بزنید تا خودرو به
            لیست مقایسه اضافه شود.
          </p>
        </div>
      ) : (
